  ...
  <div class="基石" ref="bgRef">
    <div class="bg">
      ...
      <div class="横向container" ref="containerRef">
        <div class="横向page" @scroll="scrollHandler2">
...
// import { handleScroll } from '@/js/scrollHandler.js'; // 导入 handleScroll 函数
...
// const subtractRef = ref(null);
// const multiplyRef = ref(null);
// const divideRef = ref(null);

let scrollHandler2 = null;
let animateFlag = true;

const handleScroll = () => {
  const scrollX = window.scrollX || window.pageXOffset;
  console.log('当前页面最左端距离:', scrollX);
};

onMounted(() => {
  // console.log("scrollPosition =" + document.documentElement.scrollLeft);
  // console.log("triggerPosition =" + window.innerWidth);
  nextTick(() => {
    // handleScroll(blank1Ref, containerRef, bgRef); // 调用 handleScroll 函数
    // const page1 = document.querySelector('.横向page')
    // const page1_title = document.querySelector('.横向1标题');
    // const page1_content = document.querySelector('.横向八卦介绍');
    // const page1_img = document.querySelector('.八卦图');


    // scrollHandler2 = (event) => {
    //   const scrollPosition = event.target.scrollLeft;
    //   const triggerPosition = 70 * window.innerWidth / 100 - 100; // 根据你的需求调整触发位置
    //
    //   console.log("scrollPosition =" + scrollPosition);
    //   console.log("triggerPosition =" + triggerPosition);
    //
    //   if (scrollPosition >= triggerPosition && animateFlag) {
    //
    //     page1_title.style.display = 'block';
    //     page1_content.style.display = 'block';
    //     page1_img.style.display = 'block';
    //     animateElement(page1_title, 'fadeInUp');
    //     animateElement(page1_content, 'fadeInUp');
    //     animateElement(page1_img, 'fadeInUp');
    //     // animateElement(addRef.value, 'fadeInUp');
    //     // animateElement(subtractRef.value, 'fadeInUp');
    //     // animateElement(multiplyRef.value, 'fadeInUp');
    //     // animateElement(divideRef.value, 'fadeInUp');
    //
    //     page1_title.addEventListener('animationend', () => {
    //       animateFlag = false;
    //     });
    //   }
    // };
    ...
    // page1.addEventListener('scroll', scrollHandler2);
    // initScrollAnimation();
  });
});
