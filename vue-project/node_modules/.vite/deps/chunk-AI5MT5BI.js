...
var SVGPathRebuilder = function() {
  ...
  SVGPathRebuilder2.prototype.ellipse = function(cx, cy, rx, ry, psi, startAngle, endAngle, anticlockwise) {
    ...
    var isCircle = isAroundZero2(dThetaPositive - PI26) || (clockwise ? dTheta >= PI26 : -dTheta >= PI26);
    var unifiedTheta = dTheta > 0 ? dTheta % PI26 : dTheta % PI26 + PI26;
    var large = false;
    if (isCircle) {
      large = true;
    ...
    var x0 = cx + rx * mathCos3(startAngle);
    var y0 = cy + ry * mathSin3(startAngle);
    if (this._start) {
      this._add("M", x0, y0);
    }
    ...
    if (isCircle) {
      var p = 1 / this._p;
      var dTheta_1 = (clockwise ? 1 : -1) * (PI26 - p);
      this._add("A", rx, ry, xRot, 1, +clockwise, cx + rx * mathCos3(startAngle + dTheta_1), cy + ry * mathSin3(startAngle + dTheta_1));
      if (p > 0.01) {
        this._add("A", rx, ry, xRot, 0, +clockwise, x0, y0);
      }
    } else {
      var x = cx + rx * mathCos3(endAngle);
      var y = cy + ry * mathSin3(endAngle);
...
function setTransform(attrs, m, compress) {
  if (m && !(noTranslate(m) && noRotateScale(m))) {
    ...
    attrs.transform = noRotateScale(m) ? "translate(" + round2(m[4] * mul3) / mul3 + " " + round2(m[5] * mul3) / mul3 + ")" : getMatrixStr(m);
  }
}
function convertPolyShape(shape, attrs, mul3) {
  ...
  for (var i = 0; i < points.length; i++) {
    strArr.push(round2(points[i][0] * mul3) / mul3);
    strArr.push(round2(points[i][1] * mul3) / mul3);
  }
...
function createAttrsConvert(desc) {
  ...
  return function(shape, attrs, mul3) {
    for (var i = 0; i < normalizedDesc.length; i++) {
      ...
      if (val != null) {
        attrs[item[1]] = round2(val * mul3) / mul3;
      }
    }
  };
}
...
zrender/lib/zrender.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-AI5MT5BI.js.map
