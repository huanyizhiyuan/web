        ...
        events: {
          click: function () {
            ...
            if (
              ...
              document.querySelector(".neirong").textContent = `圆周率计算：
刘徽在《九章算术注》中，提出了“割圆术”这一方法，通过多边形逼近圆形来计算圆周率，这一方法极大地提高了圆周率的计算精度。祖冲之则在此基础上进一步深入研究，不仅得出了更为精确的圆周率值，还给出了圆周率的上下限，其成果在当时世界数学史上都是领先的。
`;
            }
            ...
            if (
              ...
              document.querySelector(".neirong").textContent = `传承：
《四元玉鉴》不仅总结了前人在代数方面的成果，还提出了“四元术”这一新的代数方法，用于解决多元高次方程组的问题。
`;
            }
...
`;
            ...
            if (
              ...
              document.querySelector(
                ".neirong"
              ).textContent = `赵爽是三国时期的数学家，他在《周髀算经》的注解中详细论述了勾股定理，并且利用数形结合的思想给出了勾股定理的证明。这一研究不仅为后世研究勾股定理提供了重要思路，还启发了后世的数学家进行更深入的研究。刘徽在赵爽的基础上，进一步探讨了勾股定理的应用，并将其推广到更一般的情形，为勾股定理在数学领域的应用做出了重要贡献。
`;
            }
